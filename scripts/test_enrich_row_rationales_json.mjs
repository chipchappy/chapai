// Test script for enrich-row-rationales.mjs using mock data with JSON enforcement
...
async function main() {
  ...
  for (const q of mockQuestions) {
    ...
    let rawResponse = "";
    try {
      rawResponse = await chat(messages, { maxTokens: 800, temperature: 0.2, response_format: { type: "json_object" } });
    } catch (err) {
