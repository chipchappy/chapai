...
var BuildId = "OyJeAx5YToje1qCoZtsaO";
var HtmlPages = [];
...
var MiddlewareManifest = { "version": 3, "middleware": { "/": { "files": ["server/edge-runtime-webpack.js", "server/src/middleware.js"], "name": "src/middleware", "page": "/", "matchers": [{ "regexp": "^(?:\\/(_next\\/data\\/[^/]{1,}))?(?:\\/((?!_next\\/static|_next\\/image|favicon.ico|robots.txt|sitemap.xml|.*\\.(?:svg|png|jpg|jpeg|gif|webp|ico)$).*))(\\.json)?[\\/#\\?]?$", "originalSource": "/((?!_next/static|_next/image|favicon.ico|robots.txt|sitemap.xml|.*\\.(?:svg|png|jpg|jpeg|gif|webp|ico)$).*)" }], "wasm": [], "assets": [], "env": { "__NEXT_BUILD_ID": "OyJeAx5YToje1qCoZtsaO", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY": "eSvM3jyL0lKtQZp2DJvPFTHszAIxX//EaAz+2dTPbe0=", "__NEXT_PREVIEW_MODE_ID": "32d3194f835a9a77e71a39b4bf3d6775", "__NEXT_PREVIEW_MODE_SIGNING_KEY": "0a0ce9cd054753316543fcaa34cca2b25668fd444e30b2abc679cfe33fcb58d8", "__NEXT_PREVIEW_MODE_ENCRYPTION_KEY": "c44dcd052c55942b52ff7de14c2abf897f357cce9a1d45753101e4c66f3b5071" } } }, "functions": {}, "sortedMiddleware": ["/"] };
var AppPathRoutesManifest = { "/_not-found/page": "/_not-found", "/api/daily-question-signup/route": "/api/daily-question-signup", "/api/quiz/practice-exams/[examId]/route": "/api/quiz/practice-exams/[examId]", "/api/tutor/route": "/api/tutor", "/sitemap.xml/route": "/sitemap.xml", "/robots.txt/route": "/robots.txt", "/api/webhook/stripe/route": "/api/webhook/stripe", "/api/checkout/activate/route": "/api/checkout/activate", "/api/dashboard-auth/login/route": "/api/dashboard-auth/login", "/api/access-keys/redeem/route": "/api/access-keys/redeem", "/api/dashboard-auth/logout/route": "/api/dashboard-auth/logout", "/api/health/live/route": "/api/health/live", "/api/auth/magic-link/route": "/api/auth/magic-link", "/api/health/ready/route": "/api/health/ready", "/api/quiz/history/route": "/api/quiz/history", "/api/quiz/results/route": "/api/quiz/results", "/api/legal/accept/route": "/api/legal/accept", "/api/quiz/answer/route": "/api/quiz/answer", "/api/stripe/portal/route": "/api/stripe/portal", "/api/checkout/route": "/api/checkout", "/auth/callback/route": "/auth/callback", "/api/quiz/review-queue/route": "/api/quiz/review-queue", "/auth/logout/route": "/auth/logout", "/api/stripe/webhook/route": "/api/stripe/webhook", "/api/quiz/start/route": "/api/quiz/start", "/api/tutor/ask/route": "/api/tutor/ask", "/home/page": "/home", "/account/billing/page": "/account/billing", "/ccrn/best-study-tool/page": "/ccrn/best-study-tool", "/auth/login/page": "/auth/login", "/ccrn/24-hour-cram/page": "/ccrn/24-hour-cram", "/dashboard/page": "/dashboard", "/ccrn/ai-tutor/page": "/ccrn/ai-tutor", "/ccrn/page": "/ccrn", "/ccrn/hemodynamics-questions/page": "/ccrn/hemodynamics-questions", "/ccrn/vasoactive-drips/page": "/ccrn/vasoactive-drips", "/compare/chapai-vs-uworld/page": "/compare/chapai-vs-uworld", "/ccrn/study-plan/page": "/ccrn/study-plan", "/compare/chapai-vs-archer/page": "/compare/chapai-vs-archer", "/nclex/ai-tutor/page": "/nclex/ai-tutor", "/guild-access/page": "/guild-access", "/demo-access/page": "/demo-access", "/demo/page": "/demo", "/nclex/page": "/nclex", "/nclex/24-hour-cram/page": "/nclex/24-hour-cram", "/nclex/delegation-questions/page": "/nclex/delegation-questions", "/design-review/page": "/design-review", "/nclex/study-plan/page": "/nclex/study-plan", "/page": "/", "/nclex/prioritization-questions/page": "/nclex/prioritization-questions", "/quiz/page": "/quiz", "/success/page": "/success", "/privacy/page": "/privacy", "/terms/page": "/terms", "/upgrade/page": "/upgrade" };
var FunctionsConfigManifest = { "version": 1, "functions": { "/api/checkout/activate": {}, "/api/auth/magic-link": {}, "/api/checkout": {}, "/api/health/live": {}, "/api/health/ready": {}, "/api/legal/accept": {}, "/api/stripe/portal": {}, "/api/stripe/webhook": {}, "/api/tutor/ask": {}, "/auth/callback": {}, "/auth/logout": {} } };
