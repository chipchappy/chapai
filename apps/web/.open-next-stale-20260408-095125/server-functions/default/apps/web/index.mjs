...
var BuildId = "lUkZfQYzZc9NMF1r2s192";
var HtmlPages = [];
...
var MiddlewareManifest = { "version": 3, "middleware": { "/": { "files": ["server/edge-runtime-webpack.js", "server/src/middleware.js"], "name": "src/middleware", "page": "/", "matchers": [{ "regexp": "^(?:\\/(_next\\/data\\/[^/]{1,}))?(?:\\/((?!_next\\/static|_next\\/image|favicon.ico|robots.txt|sitemap.xml|.*\\.(?:svg|png|jpg|jpeg|gif|webp|ico)$).*))(\\.json)?[\\/#\\?]?$", "originalSource": "/((?!_next/static|_next/image|favicon.ico|robots.txt|sitemap.xml|.*\\.(?:svg|png|jpg|jpeg|gif|webp|ico)$).*)" }], "wasm": [], "assets": [], "env": { "__NEXT_BUILD_ID": "lUkZfQYzZc9NMF1r2s192", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY": "eSvM3jyL0lKtQZp2DJvPFTHszAIxX//EaAz+2dTPbe0=", "__NEXT_PREVIEW_MODE_ID": "32d3194f835a9a77e71a39b4bf3d6775", "__NEXT_PREVIEW_MODE_SIGNING_KEY": "0a0ce9cd054753316543fcaa34cca2b25668fd444e30b2abc679cfe33fcb58d8", "__NEXT_PREVIEW_MODE_ENCRYPTION_KEY": "c44dcd052c55942b52ff7de14c2abf897f357cce9a1d45753101e4c66f3b5071" } } }, "functions": {}, "sortedMiddleware": ["/"] };
var AppPathRoutesManifest = { "/_not-found/page": "/_not-found", "/api/daily-question-signup/route": "/api/daily-question-signup", "/api/quiz/practice-exams/[examId]/route": "/api/quiz/practice-exams/[examId]", "/api/tutor/route": "/api/tutor", "/api/webhook/stripe/route": "/api/webhook/stripe", "/sitemap.xml/route": "/sitemap.xml", "/robots.txt/route": "/robots.txt", "/api/access-keys/redeem/route": "/api/access-keys/redeem", "/api/dashboard-auth/login/route": "/api/dashboard-auth/login", "/api/checkout/activate/route": "/api/checkout/activate", "/api/health/live/route": "/api/health/live", "/api/auth/magic-link/route": "/api/auth/magic-link", "/api/dashboard-auth/logout/route": "/api/dashboard-auth/logout", "/api/legal/accept/route": "/api/legal/accept", "/api/quiz/history/route": "/api/quiz/history", "/api/quiz/results/route": "/api/quiz/results", "/api/checkout/route": "/api/checkout", "/api/health/ready/route": "/api/health/ready", "/api/quiz/review-queue/route": "/api/quiz/review-queue", "/api/quiz/answer/route": "/api/quiz/answer", "/api/stripe/portal/route": "/api/stripe/portal", "/auth/logout/route": "/auth/logout", "/api/quiz/start/route": "/api/quiz/start", "/api/stripe/webhook/route": "/api/stripe/webhook", "/api/tutor/ask/route": "/api/tutor/ask", "/auth/callback/route": "/auth/callback", "/home/page": "/home", "/account/billing/page": "/account/billing", "/ccrn/24-hour-cram/page": "/ccrn/24-hour-cram", "/ccrn/ai-tutor/page": "/ccrn/ai-tutor", "/auth/login/page": "/auth/login", "/ccrn/best-study-tool/page": "/ccrn/best-study-tool", "/ccrn/study-plan/page": "/ccrn/study-plan", "/ccrn/hemodynamics-questions/page": "/ccrn/hemodynamics-questions", "/ccrn/page": "/ccrn", "/compare/chapai-vs-archer/page": "/compare/chapai-vs-archer", "/compare/chapai-vs-uworld/page": "/compare/chapai-vs-uworld", "/dashboard/page": "/dashboard", "/ccrn/vasoactive-drips/page": "/ccrn/vasoactive-drips", "/demo/page": "/demo", "/demo-access/page": "/demo-access", "/guild-access/page": "/guild-access", "/design-review/page": "/design-review", "/nclex/ai-tutor/page": "/nclex/ai-tutor", "/nclex/page": "/nclex", "/nclex/24-hour-cram/page": "/nclex/24-hour-cram", "/quiz/page": "/quiz", "/nclex/study-plan/page": "/nclex/study-plan", "/nclex/delegation-questions/page": "/nclex/delegation-questions", "/nclex/prioritization-questions/page": "/nclex/prioritization-questions", "/terms/page": "/terms", "/page": "/", "/success/page": "/success", "/privacy/page": "/privacy", "/upgrade/page": "/upgrade" };
var FunctionsConfigManifest = { "version": 1, "functions": { "/api/auth/magic-link": {}, "/api/checkout/activate": {}, "/api/checkout": {}, "/api/health/ready": {}, "/api/health/live": {}, "/api/legal/accept": {}, "/api/stripe/portal": {}, "/api/stripe/webhook": {}, "/api/tutor/ask": {}, "/auth/callback": {}, "/auth/logout": {} } };
