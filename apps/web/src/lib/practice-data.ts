  ...
  return [
    {
      id: "nclex-sim-1",
      exam: "nclex",
      label: "NCLEX Readiness Exam 1",
      description: `Diagnostic NCLEX readiness exam — ${nclexLength} unique items across the full blueprint. Use this first to map your strengths and weak areas.`,
      length: nclexLength,
    ...
    },
    {
      id: "nclex-sim-2",
      exam: "nclex",
      label: "NCLEX Readiness Exam 2",
      description: `Second NCLEX readiness exam built from a non-overlapping ${nclexLength}-item bank to retest after focused study.`,
      length: nclexLength,
      timeLimitMinutes: 300,
      seed: "nclex-sim-2",
    },
    {
      id: "nclex-sim-3",
      exam: "nclex",
      label: "NCLEX Readiness Exam 3",
      description: `Third NCLEX readiness exam — ${nclexLength} reviewed items in a fresh order to keep the format honest.`,
      length: nclexLength,
      timeLimitMinutes: 300,
      seed: "nclex-sim-3",
    },
    {
      ...
      description: `Fourth non-overlapping NCLEX readiness exam with ${nclexLength} reviewed items.`,
      length: nclexLength,
      timeLimitMinutes: 300,
      seed: "nclex-sim-4",
    },
    {
      ...
      description: `Final NCLEX readiness exam — ${nclexLength} reviewed items. Save this for your last-week confidence check.`,
      length: nclexLength,
      timeLimitMinutes: 300,
      seed: "nclex-sim-5",
    },
    {
      id: "ccrn-sim-1",
      exam: "ccrn",
      label: "CCRN Readiness Exam 1",
      description: `Diagnostic CCRN readiness exam — ${ccrnLength} critical-care items focused on ICU judgment and hemodynamic patterning.`,
      length: ccrnLength,
    ...
    },
    {
      id: "ccrn-sim-2",
      exam: "ccrn",
      label: "CCRN Readiness Exam 2",
      description: `Second CCRN readiness exam — ${ccrnLength} critical-care items in a different order to retest after focused study.`,
      length: ccrnLength,
      timeLimitMinutes: 180,
      seed: "ccrn-sim-2",
    },
