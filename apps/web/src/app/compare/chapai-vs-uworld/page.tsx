...
export const metadata: Metadata = {
  title: "Clarity vs UWorld for CCRN and NCLEX | Clarity",
  description: "Compare Clarity vs UWorld for cleaner UI, exam-specific package routes, AI tutor support, and a more modern study flow for CCRN and NCLEX.",
  alternates: {
...
export default function ChapAiVsUworldPage() {
  return (
    <IntentLanding
      ...
      title="Clarity vs UWorld should feel like modern clinical study design versus older qbank sprawl."
      body="Clarity is being built around cleaner editorial UX, exam-specific packages, tutor follow-up, and a more guided study surface instead of dumping users into another generic question warehouse."
      stats={[
      ...
      secondaryHref="/"
      secondaryLabel="See Clarity"
      whyTitle="Comparison pages catch buyers who are already evaluating alternatives."
      whyBody="That is high-intent traffic. The goal is not to attack established tools loudly; it is to show that Clarity is calmer, cleaner, and more focused on how modern learners actually move through a study product."
      proofPoints={[
      ...
      buyerBody="This audience is already in evaluation mode. They need a clear reason to believe Clarity is more modern and more focused on their exam."
      ...
      faq={[
        {
          question: "What is the core Clarity argument in a comparison page?",
