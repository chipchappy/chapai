...
export const metadata: Metadata = {
  ...
  icons: {
    // v3 = tight-cropped brand "c" (was heavily padded → unrecognizable at tab/search sizes).
    // Query string busts browser + Google favicon caches so the new mark propagates.
    icon: [
