...
export const drugCards = sqliteTable("drug_cards", {
  ...
  brandNames: text("brand_names").default("[]"),
  drugClass: text("drug_class").notNull(),
  mechanism: text("mechanism"),
  indications: text("indications").default("[]"),
  priorityLabs: text("priority_labs").default("[]"),
  nursingAssessments: text("nursing_implications").default("[]"),
